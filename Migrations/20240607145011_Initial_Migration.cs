        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowsTokenRefreshEnabled = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPageAccesses_AppPages_AppPageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPositions_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPositions_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPositions_Divisions_DivisionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPageAccesses_AppPageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPositions_CompanyId",
                table: "UserPositions",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPositions_DepartmentId",
                table: "UserPositions",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPositions_DivisionId",
                table: "UserPositions",
                column: "DivisionId");
